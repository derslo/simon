<div class="navbar-custom-menu pull-left">
    <ul class="nav navbar-nav">
        ...
        <li><a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/service') }}"><i
                        class="fa fa-rocket"></i> <span>Dienste</span></a></li>
    ...
    <ul class="nav navbar-nav">
      ...
      <!-- <li><a href="{{ url('/') }}"><i class="fa fa-home"></i> <span>Home</span></a></li> -->
        ...
        @if (Auth::guest())
            ...
            @endif
        @else
            <li><a href="{{ route('home') }}"><i class="fa fa-btn fa-sign-out"></i> {{ trans('backpack::base.logout') }}</a></li>
        @endif
